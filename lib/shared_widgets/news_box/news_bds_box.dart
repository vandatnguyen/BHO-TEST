...
import 'news_bds_box_controller.dart';
import 'news_box_controller.dart';
import 'news_trading_box_controller.dart';

class BoxBSDNews extends GetView<NewsBDSBoxController> {
  const BoxBSDNews({Key? key}) : super(key: key);
